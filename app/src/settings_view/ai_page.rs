...
struct ApiKeysWidget {
    ...
    mimo_api_key_editor: ViewHandle<EditorView>,
...
impl ApiKeysWidget {
    ...
    fn render_api_keys_section(
        ...
        column.add_child(render_api_key_input(
            appearance,
            "Xiaomi MiMo API Key",
            self.mimo_api_key_editor.clone(),
            is_enabled,
            app,
        ));
...
impl SettingsWidget for ApiKeysWidget {
    ...
    fn search_terms(&self) -> &str {
        "api keys bring your own byo openai anthropic google claude gemini gpt mimo xiaomi"
    }
